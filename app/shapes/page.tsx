...
export default function CustomizedPage() {
  ...
  <p className="text-[#6B6B6B] text-lg mt-4 max-w-2xl mx-auto">
  Fun shape coloring activities featuring Mickey Mouse and flowers, designed to boost creativity, 
  color recognition, and joyful learning through play.
</p>
</p>
        </p>
      ...
      <section className="px-6 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md">
            ...
            <img src="/a7.jpg" className="w-full h-60 object-cover" />
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md">
            ...
            <img src="/a8.jpg" className="w-full h-60 object-cover" />
