...
export default function CustomizedPage() {
  ...
  Creative stitching keychains for kids to practice threading, improve fine motor skills, 
  and enjoy fun hands-on learning through colorful designs.
</p>
        </p>
      ...
      <section className="px-6 pb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md">
            ...
            <img src="/a4.jpg" className="w-full h-60 object-cover" />
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md">
            ...
            <img src="/a3.jpg" className="w-full h-60 object-cover" />
